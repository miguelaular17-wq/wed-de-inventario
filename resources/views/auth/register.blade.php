        ...
        <form method="POST" action="{{ route('register.store') }}" style="display: flex; flex-direction: column; gap: 16px;">
            ...
            <div class="auth-field">
                ...
                <div style="position: relative; display: flex; align-items: center; width: 100%;">
                    <input type="password" id="password" name="password" placeholder="Mínimo 6 caracteres" required minlength="6" style="padding-right: 40px;">
            ...
            <div class="auth-field">
                ...
                <div style="position: relative; display: flex; align-items: center; width: 100%;">
                    <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Repite tu contraseña" required style="padding-right: 40px;">
                    <button type="button" id="toggle-password-conf" class="password-toggle-btn" aria-label="Mostrar contraseña">
                        <svg class="eye-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                            <circle cx="12" cy="12" r="3"></circle>
                        </svg>
...
(function() {
    ...
    setupPasswordToggle('password_confirmation', 'toggle-password-conf');
})();
</script>
@endpush
