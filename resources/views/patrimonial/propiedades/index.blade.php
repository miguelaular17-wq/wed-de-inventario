        ...
        <div class="pat-prop-grid">
            ...
            <div class="pat-prop-card">
                ...
                <div class="pat-prop-footer">
                    ...
                    <a href="{{ route('patrimonial.reportes.propiedad.pdf', ['propiedad' => $prop, 'mes' => now()->month, 'anio' => now()->year]) }}" target="_blank" class="pat-btn pat-btn-sm" style="flex:1; justify-content:center; background:#dc2626; color:#fff; border:none;" title="Descargar Reporte PDF">📄 PDF</a>
                </div>
            </div>
            @endforeach
        </div>
