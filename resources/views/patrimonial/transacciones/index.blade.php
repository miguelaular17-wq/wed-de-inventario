...
<div style="max-width:1300px; margin:0 auto; padding:24px 20px;">
    ...
    <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px; margin-bottom:20px;">
        ...
        <div style="display:flex; gap:8px; flex-wrap:wrap;">
            <a href="{{ route('patrimonial.reportes.incremento_valor', ['mes' => $mes, 'anio' => $anio]) }}" style="display:inline-flex; align-items:center; gap:6px; padding:9px 18px; border-radius:8px; font-weight:600; font-size:0.88rem; text-decoration:none; background:#d97706; color:#fff;">
                🔨 Incremento de Valor
            </a>
