...
<div class="edurar-wrap">
    ...
    <div style="margin-bottom: 20px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:12px;">
        ...
        <div>
            <a href="{{ route('comprador.dashboard') }}" style="display: inline-flex; align-items: center; justify-content: center; padding: 8px 16px; background: #f1f5f9; color: #475569; font-weight: 600; text-decoration: none; border-radius: 8px; border: 1px solid #e2e8f0; font-size: 0.9rem;">
    ...
    {{-- Filters --}}
    <form method="GET" action="{{ route('comprador.existencias') }}" id="edurar-form">
        <div class="edurar-filters">
            ...
            @if($filters['q'] !== '' || $filters['categoria'] !== 'Ninguno' || $filters['proveedor'] !== 'Ninguno')
                <a href="{{ route('comprador.existencias') }}" class="filter-btn clear">Limpiar</a>
            @endif
        </div>
    </form>
...
selCat.addEventListener('change', function () {
    ...
    fetch('{{ route("comprador.existencias.subcategorias") }}?categoria=' + encodeURIComponent(cat))
        .then(r => r.json())
        .then(subs => {
