-- Esquema inventario_v2 para Laravel (sin tablas compra)
-- Equivalente a database/migrations/2026_06_04_000001_create_inventario_v2_schema.php

CREATE SCHEMA IF NOT EXISTS inventario_v2;
