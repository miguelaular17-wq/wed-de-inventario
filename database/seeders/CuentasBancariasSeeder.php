...
class CuentasBancariasSeeder extends Seeder
{
    public function run(): void
    {
        ...
        \Illuminate\Support\Facades\DB::statement('TRUNCATE TABLE planificacion_pagos RESTART IDENTITY CASCADE');
        ...
        // Crear las 7 filas vacias para planificacion
        for($i = 1; $i <= 7; $i++) {
            \App\Models\PlanificacionPago::create([
                'orden' => $i
            ]);
        }
