...
class EdurarController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        $categorias = Cache::remember('edurar_categorias', 3600, function () {
        ...
        $proveedores = Cache::remember('edurar_proveedores', 3600, function () {
            return DB::connection('pgsql')
                ->table('inventario_v2.productos')
                ->where('activo', true)
        ...
        return view('edurar.existencias', [
            'rows'          => $paginator,
            'filters'       => $filters,
