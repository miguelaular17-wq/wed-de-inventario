...
<div class="panel" style="margin-top:24px;" data-tour="admin-recommendations">
    <div style="display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap;">
        <div>
            ...
            <p class="muted" style="margin:10px 0 0;font-size:.95rem;"><strong><?php echo e($recommendedProductCount); ?></strong> productos recomendados / <strong><?php echo e($recommendedTotalUnits); ?></strong> unidades sugeridas</p>
        </div>
        <form method="GET" style="display:flex;gap:12px;align-items:center;">
            ...
            <select id="proveedor-select" name="proveedor" onchange="this.form.submit()" style="min-width:220px;">
                ...
                <?php $__currentLoopData = $proveedores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($prov); ?>" <?php if($selectedProveedor === $prov): echo 'selected'; endif; ?>><?php echo e($prov); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </form>
    </div>

    <?php if($recomendados->isEmpty()): ?>
    ...
    <?php else: ?>
        <div style="margin-top:16px; overflow-x:auto;">
            <table class="data-table" style="min-width:860px;">
                ...
                <tbody>
                    <?php $__currentLoopData = $recomendados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="selectable-row" data-producto="<?php echo e($row['producto']); ?>" data-stocks='<?php echo json_encode($row['stocks'], 15, 512) ?>' data-ventas='<?php echo json_encode($row['ventas_internas'], 15, 512) ?>' data-ventas15='<?php echo json_encode($row['ventas_internas_15d'], 15, 512) ?>'>
                            <td><?php echo e($row['cod_centro']); ?></td>
                            <td><?php echo e($row['producto']); ?></td>
                            <td><?php echo e($row['proveedor'] ?? '—'); ?></td>
                            <td><?php echo e($row['total_stock']); ?></td>
                            <td><?php echo e($row['total_demanda']); ?></td>
                            <td><strong><?php echo e($row['sugerido']); ?></strong></td>
