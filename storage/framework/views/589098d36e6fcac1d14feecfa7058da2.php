...
<?php else: ?>
    <p class="muted" style="margin:0 0 16px;">
        Exporta requisiciones registradas en <a href="<?php echo e(route('inventario.index')); ?>">Inventario</a>.
        Al descargar el CSV se <strong>aplica el movimiento de stock</strong> (resta en origen, suma en <?php echo e($sede); ?>).
    </p>
<?php endif; ?>
